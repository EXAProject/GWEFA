...
function html_start($title, $refresh = 0, $cacheable = true, $report = false)
{
    ...
    echo '<table border="0"  width="100%"  class="top_bar">' . "\n";
    echo '<tr>' . "\n";
    echo '<td>' . "\n";
    echo '<ul id="menu1" class="yellow">' . "\n";
    // Display the different words

    echo '<li><i class="fa fa-user" aria-hidden="true"></i><span>Welcome</span> ' . $_SESSION['fullname'] . '</li>' . "\n";
//     echo '<li><i class="fa fa-clock-o" aria-hidden="true"></i>
// ' . __('cst03') . ' <span id="clock">&nbsp;</span></li>' . "\n";
    echo '<li><i class="fa fa-clock-o" aria-hidden="true"></i> <span id="clock">&nbsp;</span></li>' . "\n";

    echo '</ul>'. "\n"; 
    echo '</td>' . "\n";
    
    /////Start Search Bar///////
    echo '<td class="jump" align="left">' . "\n";
    echo '<form action="./detail.php">' . "\n";
    echo '<p> <i class="fa fa-search" aria-hidden="true" style="display: inline;"></i><input type="text" name="id" value="' . $message_id . '" placeholder="Enter massage id..." class="searchinput"></p>' . "\n";
    ...
    echo '<td>' . "\n";
    echo '<ul id="menu2" class="yellow">' . "\n";
    // Display the different words
    echo '<li><a href="logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i><span>Logout</span></a></li>' . "\n";
    echo '<li><a href="user_manager.php"><i class="fa fa-cogs" aria-hidden="true"></i><span>User Management</span></a></li>' . "\n";
    ...
    echo '<td align="left" class="responsive"><a href="index.php" class="logo"><img src="' . IMAGES_DIR . MW_LOGO . '" alt="' . __('mailwatchtitle03') . '"></a></td>' . "\n";
    printNavBar();
...
//<=========================== END Remove Service Status ==================================>
    ...
    // MailScanner running?
        if (!DISTRIBUTED_SETUP) {
            ...
            echo '     <tr><td class="insights_info">' . __('mailscanner03') . '</td><td class="insights_info" align="center">' . $running . '</td><td class="insights_info" align="right">' . $procs . '</td></tr>' . "\n";
        ...
        // is MTA running
            ...
            $procs = count($output) . ' ' . __('procs03');
            echo '    <tr><td class="insights_info">' . ucwords($mta) . __('colon99') . '</td>'
            . '<td class="insights_info" align="center">' . $running . '</td><td class="insights_info" align="right">' . $procs . '</td></tr>' . "\n";
        }
    }
    ...
    // Load average
        if (!DISTRIBUTED_SETUP && file_exists('/proc/loadavg')) {
            ...
            echo '
            <tr>
                <td class="insights_info" align="left" rowspan="3">' . __('loadaverage03') . '&nbsp;</td>
                <td class="insights_info" align="right">' . __('1minute03') . '&nbsp;</td>
                <td class="insights_info" align="right">' . $la_1m . '</td>
            </tr>
        </tr>
        <td class="insights_info" align="right" colspan="1">' . __('5minutes03') . '&nbsp;</td>
        <td class="insights_info" align="right">' . $la_5m . '</td>
    </tr>
    <td class="insights_info" align="right" colspan="1">' . __('15minutes03') . '&nbsp;</td>
    <td class="insights_info" align="right">' . $la_15m . '</td>
</tr>
' . "\n";
...
function printMTAQueue()
{
    ...
    if (get_conf_var('MTA', true) === 'postfix') {
        ...
        if (is_readable($incomingdir) || is_readable($outgoingdir)) {
            ...
            echo '    <tr><td class="insights_info" colspan="3">' . __('verifyperm03') . ' ' . $incomingdir . ' ' . __('and03') . ' ' . $outgoingdir . '</td></tr>' . "\n";
        }
        ...
        if (DISTRIBUTED_SETUP && defined('RPC_REMOTE_SERVER')) {
            ...
            if ($pqerror !== '') {
                echo '    <tr><td class="insights_info" colspan="3">' . __('errorWarning03') . ' ' . $pqerror . '</td>' . "\n";
            }
        }
        if ($inq !== null && $outq !== null) {
            echo '    <tr><td colspan="3" class="insights_head" align="center">' . __('mailqueue03') . '</td></tr>' . "\n";
            echo '    <tr><td class="insights_info" colspan="2"><a href="postfixmailq.php">' . __('inbound03') . '</a></td><td class="insights_info" align="right">' . $inq . '</td>' . "\n";
            echo '    <tr><td class="insights_info" colspan="2"><a href="postfixmailq.php">' . __('outbound03') . '</a></td><td class="insights_info" align="right">' . $outq . '</td>' . "\n";
        }
        ...
        echo '    <tr><td colspan="3" class="insights_head" align="center">' . __('mailqueue03') . '</td></tr>' . "\n";
        echo '    <tr><td class="insights_info" colspan="2"><a href="mailq.php?token=' . $_SESSION['token'] . '&amp;queue=inq">' . __('inbound03') . '</a></td><td class="insights_info" align="right">' . $inq . '</td>' . "\n";
        echo '    <tr><td class="insights_info" colspan="2"><a href="mailq.php?token=' . $_SESSION['token'] . '&amp;queue=outq">' . __('outbound03') . '</a></td><td class="insights_info" align="right">' . $outq . '</td>' . "\n";
    }
}
...
function printFreeDiskSpace()
{
    if (!DISTRIBUTED_SETUP) {
        // Drive display
        echo '    <tr><td colspan="3" class="insights_head" align="center">' . __('freedspace03') . '</td></tr>' . "\n";
        foreach (get_disks() as $disk) {
            ...
            $percent .= '%] ';
            $percent .= '</span>';
            echo '    <tr><td class="insights_info">' . $disk['mountpoint'] . '</td><td class="insights_info" colspan="2" align="right">' . formatSize($free_space) . $percent . '</td>' . "\n";
        }
    }
}
...
function printTodayStatistics()
{
    ...
    while ($row = $sth->fetch_object()) {
        echo '<table align="center" border="0" cellpadding="5" cellspacing="4" style="height:300px; width:1000px">' . "\n";
        echo '<tr>' . "\n";
        echo '<td align="left">' . "\n";
        echo '<table border="0" cellpadding="5" cellspacing="5"  width="400px" height="150px" class="new_mail">' . "\n";
        echo ' <tr><th align="left" colspan="4" style="font-size: 18px;color: #696969;">Total Number Of Messages Today</th></tr>' . "\n";

        echo ' <tr><td colspan="3"><hr></td></tr>' . "\n";

        echo ' <tr><td align="right">' . number_format(
            $row->clean ) . '</td><td class="borderleft" align="left">' . $row->cleanpercent . '%</td><td> <div class="clean_1"></div></td><td class="font_size">' . __('cleans03') . '</td></tr>' . "\n";

        echo ' <tr><td align="right">' . number_format( $row->viruses ) . '</td><td class="borderleft" align="left">' . $row->viruspercent . '%<td > <div class="infected"></div>  </td><td class="font_size">' . __('viruses03') . '</td></tr>' . "\n";


        echo ' <tr><td align="right">' . number_format( $row->blockedfiles ) . '</td><td class="borderleft" align="left">' . $row->blockedfilespercent . '%</td><td> <div class="blacklisted"></div> </td><td class="font_size">' . __('blockedfiles03') . '</td></tr>' . "\n";

        echo ' <tr><td align="right">' . number_format( $row->otherinfected ) . '</td><td class="borderleft" align="left">' . $row->otherinfectedpercent . '%</td><td > <div class="notscanned"></div> </td><td class="font_size">' . __('others03') . '</td></tr>' . "\n";

        echo ' <tr><td align="right">' . number_format( $row->spam ) . '</td><td class="borderleft" align="left">' . $row->spampercent . '%</td><td><div class="spam"></div> </td><td class="font_size">' . __('spam03') . '</td></tr>' . "\n";

        echo ' <tr><td align="right">' . number_format( $row->highspam ) . '</td><td class="borderleft" align="left">' . $row->highspampercent . '%</td><td > <div class="highspam"></div> </td><td style="white-space:nowrap" class="font_size">' . __('hscospam03') . '</td></tr>' . "\n";

        if (get_conf_truefalse('mcpchecks')) {
            echo ' <tr><td align="right">' . number_format( $row->mcp ) . '</td><td class="borderleft" align="left">' . $row->mcppercent . '%</td><td > <div class="mcp"></div> </td><td class="font_size">MCP</td></tr>' . "\n";

            echo ' <tr><td align="right">' . number_format( $row->highmcp ) . '</td><td class="borderleft" align="left">' . $row->highmcppercent . '%</td><td> <div class="highmcp"></div> </td><td style="white-space:nowrap" class="font_size">' . __('hscomcp03') . '</td></tr>' . "\n";
        }
        echo ' <tr> <td colspan="4"><hr></td></tr>';
        echo ' <tr>
        <td align="right">' . number_format( $row->processed ) . '</td>
        <td align="left">100%</td><td colspan="2" align="left">' . __('processed03') . '</td></tr>' . "\n";
   ...
   ///////////////////////////////
        ...
        echo '<table border="0" cellpadding="5" cellspacing="5"  width="400px" height="150px" class="new_mail">' . "\n";
        echo ' <tr><th align="left" colspan="4" style="font-size: 18px;color: #696969;">Status</th></tr>' . "\n";
        echo ' <tr><td colspan="2"><hr></td>
               <td colspan="2"></td></tr>' . "\n";

        echo ' <tr><td colspan="4"><div class="percent percentage1-' . round($row->cleanpercent) . ' percentage1-bg1"></div></td></tr>' . "\n";

        echo ' <tr><td colspan="4"><div class="percent percentage1-' . round($row->viruspercent) . ' percentage1-bg2"></div></td></tr>' . "\n";

        echo ' <tr><td colspan="4"><div class="percent percentage1-' . round($row->blockedfilespercent) . ' percentage1-bg4"></div></td></tr>' . "\n";

        echo ' <tr><td colspan="4"><div class="percent percentage1-' . round($row->otherinfectedpercent) . ' percentage1-bg5"></div></td></tr>' . "\n";

        echo ' <tr><td colspan="4"><div class="percent percentage1-' . round($row->spampercent) . ' percentage1-bg6"></div></td></tr>' . "\n";
        echo ' <tr><td colspan="4"><div class="percent percentage1-' . round($row->highspampercent) . ' percentage1-bg7"></div></td></tr>' . "\n";

        if (get_conf_truefalse('mcpchecks')) {
          echo ' <tr><td colspan="4"><div class="percent percentage1-' . round($row->mcppercent) . ' percentage1-bg8"></div></td></tr>' . "\n";

          echo ' <tr><td colspan="4"><div class="percent percentage1-' . round($row->highmcppercent) . ' percentage1-bg9"></div></td></tr>' . "\n";
      }
      echo ' <tr> <td  colspan="4"><hr></td></tr>';
      echo ' <tr><td align="left" colspan="4">0&nbsp;&nbsp&nbsp10&nbsp;&nbsp&nbsp20&nbsp;&nbsp&nbsp30&nbsp;&nbsp&nbsp40&nbsp;&nbsp&nbsp50&nbsp;&nbsp&nbsp60&nbsp;&nbsp&nbsp70&nbsp;&nbsp&nbsp80&nbsp;&nbsp&nbsp90&nbsp;&nbsp&nbsp100</td></tr>' . "\n";
...
function printNavBar()
{
    ...
    $nav = array();
    $nav['dashboard.php'] = __('dashboard00');
    ...
    //Navigation table
    // echo '<tr class="noprint">' . "\n";
    echo '<td colspan="2" class="nav_responsive">
    <a href="index.php" class="show-logo" id="logo_small"><img src="' . IMAGES_DIR . MW_LOGO . '" alt="' . __('mailwatchtitle03') . '"></a>
    ...
    foreach ($nav as $url => $desc) {
        ...
        if ($_SERVER['SCRIPT_FILENAME'] === $active_url) {
            ...
            <a href=\"$url\">
                <figure class=\"item\">
                  <img src=\"images/$desc.png\" alt=\"$desc\"/>
                  <figcaption class=\"caption\">$desc</figcaption>
              </figure>
          </a>
      </li>\n";
  } else {
    ...
    if ($rows > 0) {
        ...
        for ($f = 0; $f < $fields; $f++) {
            ...
            switch ($fieldname[$f] = $fieldInfo->name) {
                ...
                break;
                case 'id2':
                $fieldname[$f] = '<img src="images/mailicon.png"></i>';
                $orderable[$f] = false;
                $align[$f] = 'center';
                break;
                case 'size':
            ...
            if ($display[$f]) {
                if ($order && $orderable[$f]) {
                    ...
                    . '&amp;orderdir=a' . subtract_multi_get_vars(
                        ...
                        ) . '" style="color: #ebebeb;">&uarr;</a>/<a href="?orderby=' . $fieldInfo->name
                    . '&amp;orderdir=d' . subtract_multi_get_vars(array('orderby', 'orderdir')) . "\"style='color: #ebebeb;'>&darr;</a>)\n";
                    echo "  </th>\n";
                } else {
        ...
        for ($r = 0; $r < $rows; $r++) {
            ...
            for ($f = 0; $f < $fields; $f++) {
                ...
                switch ($field->name) {
                    ...
                    $row[$f] = '<a href="detail.php?token=' . $_SESSION['token'] . "&amp;id=$row[$f]\" ><i class=\"fa fa-envelope-open fa-2x\" aria-hidden=\"true\"></i></a>";
                    break;
                    case 'from_address':
...
function printGraphTable(
    ...
    echo '    <tr style="background-color: #006f57">' . "\n";
    foreach ($columnTitles as $columnTitle) {
        echo '     <th style="color:#ffffff;">' . $columnTitle . '</th>' . "\n";
    }
    echo '    </tr>' . "\n";
